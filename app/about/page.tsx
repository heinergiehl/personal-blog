          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-2/3 flex flex-col justify-center">
              ...
              <p className="text-gray-600 text-lg mb-4">
                Hello! I'm Heiner, a passionate software developer and tech
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-gray-900">
              Heiner's Journey as a Coder
            </h2>
            <p className="mt-4 text-lg text-gray-600">
              From curious beginner to seasoned developer, here's how Heiner
          ...
          <div className="space-y-12">
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-2/3 md:pl-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600">
                  Heiner’s coding journey began in high school when he stumbled
                  upon his first programming language—Python. What started as a
                  simple curiosity quickly turned into a passion, as Heiner
                  spent countless hours experimenting with code, building small
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              <div className="md:w-1/3">
                <img
                  src="/unhappy.jpg"
                  alt="Heiner learning new skills"
                  className="w-full rounded-lg shadow-lg"
                />
              </div>
              <div className="md:w-2/3 md:pr-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600">
                  After mastering the basics, Heiner’s thirst for knowledge
                  grew. He began exploring more complex topics such as data
                  structures, algorithms, and web development. Enrolling in
                  online courses and attending coding bootcamps, Heiner quickly
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/3">
                <img
                  src="/happy.jpg"
                  alt="Heiner working on a big project"
                  className="w-full rounded-lg shadow-lg"
                />
              </div>
              <div className="md:w-2/3 md:pl-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600">
                  With several years of experience under his belt, Heiner began
                  tackling more significant challenges. From contributing to
                  open-source projects to developing his own applications,
                  Heiner continued to push his limits, always looking for
